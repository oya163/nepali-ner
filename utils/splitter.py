...
'''
def split_train_test(sent_file, tag_file, save_path, logger):
...
#         os.mkdir(save_path)
    ...
    write_df(train_df, train_fname)
    write_df(test_df, test_fname)
    write_df(val_df, val_fname)
...
def split(input_file, save_path, verbose, logger):  
    ...
    split_train_test(sent_file, tag_file, save_path, logger)
...
if __name__=="__main__":
    ...
    parser.add_argument("-i", "--input_file", default="./data/dataset.txt", metavar="PATH", help="Input file path")
    parser.add_argument("-o", "--output_dir", default="./data/kfold", metavar="PATH", help="Output Directory")
